...
| **OmniContact.get** | v4 | Retrieve real-time contact snapshot from Acoustic/Silverpop. | `database_id`, `email`, `contact_id`, `group_identifier`, `recipientID` | e.g wmf-cv api4 Omnicontact.get recipientID=748572098415         |
