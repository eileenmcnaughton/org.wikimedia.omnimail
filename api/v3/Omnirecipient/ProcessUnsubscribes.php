...
function civicrm_api3_omnirecipient_process_unsubscribes($params) {
  ...
  while ($result->fetch()) {
    ...
    civicrm_api3('Activity', 'create', array('activity_type_id' => 'Unsubscribe', 'campaign_id' => 'sp' . $result->mailing_identifier, 'target_contact_id' => $result->contact_id, 'source_contact_id' => $result->contact_id));
